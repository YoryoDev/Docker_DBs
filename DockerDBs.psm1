...
#        cp .\DockerDBs.psm1 "$HOME\Documents\PowerShell\Modules\DockerDBs\"
#      (crea la carpeta Modules\DockerDBs\ si no existe)
#
#   2. Importar en tu profile.ps1:
...
# Si lo clonaste en otra ruta, definí antes de Import-Module:
